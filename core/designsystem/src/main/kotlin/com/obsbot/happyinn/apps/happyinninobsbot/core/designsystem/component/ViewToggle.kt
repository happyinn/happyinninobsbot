...
fun HioViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = HioViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        HioViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) HioIcons.ViewDay else HioIcons.ShortText,
 ...
 */
@Composable
private fun HioViewToggleButtonContent(
