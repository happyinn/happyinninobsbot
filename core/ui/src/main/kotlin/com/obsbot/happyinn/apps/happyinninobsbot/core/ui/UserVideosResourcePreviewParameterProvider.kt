...
import com.obsbot.happyinn.apps.happyinninobsbot.core.ui.PreviewParameterData.videosResources
 ...
 * provides list of [UserVideosResource] for Composable previews.
 */
class UserVideosResourcePreviewParameterProvider : PreviewParameterProvider<List<UserVideosResource>> {

    override val values: Sequence<List<UserVideosResource>> = sequenceOf(videosResources)
}

object PreviewParameterData {

    private val userData: UserData = UserData(
        bookmarkedVideosResources = setOf("1", "3"),
        viewedVideosResources = setOf("1", "2", "4"),
    ...
    val topics = listOf(
        Topic(
            id = "2",
            name = "Headlines",
            shortDescription = "Videos we want everyone to see",
