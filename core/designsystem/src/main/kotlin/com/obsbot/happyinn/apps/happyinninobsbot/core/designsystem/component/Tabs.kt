    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = HioTabDefaults.TabTopPadding)) {
                        text()
                    }
                },
            )
 ...
 * @param tabs The tabs inside this tab row. Typically this will be multiple [HioTab]s. Each element
