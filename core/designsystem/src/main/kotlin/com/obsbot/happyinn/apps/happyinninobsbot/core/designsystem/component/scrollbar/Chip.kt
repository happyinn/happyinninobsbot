package com.obsbot.happyinn.apps.happyinninobsbot.core.designsystem.component.scrollbar
...
import com.obsbot.happyinn.apps.happyinninobsbot.core.designsystem.component.ThemePreviews
    ...
    FilterChip(
        ...
        border = FilterChipDefaults.filterChipBorder(
            ...
            disabledBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = HioChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            disabledSelectedBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = HioChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            selectedBorderWidth = HioChipDefaults.ChipBorderWidth,
        ),
        colors = FilterChipDefaults.filterChipColors(
            ...
            disabledContainerColor = if (selected) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = HioChipDefaults.DISABLED_CHIP_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun ChipPreview() {
    HioTheme {
        HioBackground(modifier = Modifier.size(80.dp, 20.dp)) {
            HioFilterChip(selected = true, onSelectedChange = {}) {
                Text("Chip")
            }
        }
    }
